...
@section('title', 'Upload Gambar Harian')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        <h1 class="h2">Upload Gambar Harian</h1>
    </div>

    <div class="card">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">Upload Gambar Harian</h5>
        </div>
        <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal" name="tanggal" value="{{ old('tanggal', isset($existingImage) ? $existingImage->tanggal->format('Y-m-d') : today()->format('Y-m-d')) }}" required>
                            @error('tanggal')
