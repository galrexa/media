            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        @if($isu->main_image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $isu->main_image) }}" class="img-thumbnail" style="max-height: 100px;">
                                <p class="text-muted">Gambar yang sudah ada akan diganti jika Anda upload yang baru.</p>
                            </div>
                        @endif
                        @error('image_1')
                            <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        @if($isu->thumbnail_image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $isu->thumbnail_image) }}" class="img-thumbnail" style="max-height: 100px;">
                                <p class="text-muted">Gambar yang sudah ada akan diganti jika Anda upload yang baru.</p>
                            </div>
                        @endif
                        @error('image_2')
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        @if($isu->banner_image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $isu->banner_image) }}" class="img-thumbnail" style="max-height: 100px;">
                                <p class="text-muted">Gambar yang sudah ada akan diganti jika Anda upload yang baru.</p>
                            </div>
                        @endif
                        @error('image_3')
