        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-3">
                <div class="card-header bg-info text-white">
                    <h6><i class="fas fa-bug me-2"></i>Status & Debug</h6>
                </div>
                <div class="card-body small">
                    <div class="mb-2">
                        <strong>JavaScript:</strong> <span class="badge bg-success">✅ Loaded</span>
                    </div>
                    <div class="mb-2">
                        <strong>URL Count:</strong> <span id="url-count" class="badge bg-primary">1</span>
                    </div>
                    <div class="mb-2">
                        <strong>CSRF Token:</strong> 
                        <span class="badge bg-{{ csrf_token() ? 'success">✅ Found' : 'danger">❌ Missing' }}"></span>
                    </div>
                    <div class="mb-2">
                        <strong>Last Action:</strong>
                        <br><small id="debug-last-action" class="text-muted">Ready</small>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-3" id="preview-card" style="display: none;">
                <div class="card-header bg-success text-white">
                    <h6><i class="fas fa-eye me-2"></i>Preview URLs</h6>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body small">
                    <ol>
                        <li><strong>Test Functions:</strong> Klik tombol test untuk memastikan semua berfungsi</li>
                        <li><strong>Input URLs:</strong> Masukkan 1-5 URL berita yang valid</li>
                        <li><strong>Preview:</strong> Lihat preview URLs sebelum analisis</li>
